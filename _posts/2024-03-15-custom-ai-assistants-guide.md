...
If you're new to local models, start with our [beginner's guide to getting started with local LLMs](/blog/2024/04/04/getting-started-with-local-llms/). You can also pair your custom assistants with [automated workflows using Apple Shortcuts](/blog/2024/03/01/maximizing-productivity-with-ai-shortcuts/).
